<template>
  <div class="container-custom mx-auto section-padding py-8">
          ...
          <div class="form-control">
            <label class="cursor-pointer label justify-start">
              ...
              <span class="label-text">
                He leído y acepto la <a href="#" class="link link-primary">política de privacidad</a>
              </span>
            </label>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-gray-600">Domingos y festivos: Cerrado</p>
            </div>
          </div>
        </div>
    ...
    <!-- Map Section -->
    <div class="mt-16">
      <h2 class="text-2xl font-semibold mb-6">Encuéntranos</h2>
      <div class="w-full h-96 bg-base-200 rounded-lg flex items-center justify-center">
        <p class="text-gray-500">Mapa interactivo aquí</p>
      </div>
    </div>
  </div>
</template>
