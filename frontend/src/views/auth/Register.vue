<template>
  ...
  <!-- Modal de verificación pendiente -->
  <div v-if="showVerificationModal" class="modal modal-open">
    <div class="modal-box">
      ...
      <div class="py-4">
        <div class="alert alert-info">
          ...
          <div>
            <p class="font-semibold">Su cuenta está pendiente de verificación</p>
            <p class="text-sm mt-1">Un administrador revisará su solicitud y le notificará cuando su cuenta esté activada.</p>
          </div>
        </div>
        <p class="mt-4">
          Por favor, espere a recibir un correo de confirmación antes de intentar iniciar sesión.
        </p>
      </div>
...
const handleRegister = async () => {
  ...
  if (result.success) {
    if (result.needsVerification) {
      // Mostrar modal o redirigir a página de confirmación
